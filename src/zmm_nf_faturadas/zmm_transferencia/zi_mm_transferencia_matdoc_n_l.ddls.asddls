...
define view entity ZI_MM_TRANSFERENCIA_MATDOC_N_L
  as select from I_MaterialDocumentItem as _Matdoc
{
  ...
  key _Matdoc.PurchaseOrderItem                                                                                       as PurchaseOrderItem,
      ...
      max( concat( concat( _Matdoc.MaterialDocument, _Matdoc.MaterialDocumentYear ), _Matdoc.MaterialDocumentItem ) ) as MaterialDocument
