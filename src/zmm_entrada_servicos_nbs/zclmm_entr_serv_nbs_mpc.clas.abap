class ZCLMM_ENTR_SERV_NBS_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCLMM_ENTR_SERV_NBS_MPC=======CP' ##NO_TEXT.

  methods DEFINE_UPLOAD
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCLMM_ENTR_SERV_NBS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMM_ENTR_SERV_NBS_SRV' ).

define_upload( ).
  endmethod.


  method DEFINE_UPLOAD.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Upload' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCLMM_ENTR_SERV_NBS_MPC=>TS_UPLOAD' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'UploadSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230313145402'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Upload'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Conteudo'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Upload'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
