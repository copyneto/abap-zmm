class ZCLMM_CX_FMT_CANCELAR_ITEM_REQ definition
  public
...
public section.
  ...
  data STANDARD type ZCLMM_EXCHANGE_FAULT_DATA1 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLMM_EXCHANGE_FAULT_DATA1 optional
...
CLASS ZCLMM_CX_FMT_CANCELAR_ITEM_REQ IMPLEMENTATION.
