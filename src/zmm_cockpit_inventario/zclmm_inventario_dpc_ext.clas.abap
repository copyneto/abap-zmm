CLASS zclmm_inventario_dpc_ext DEFINITION
  PUBLIC
  INHERITING FROM zclmm_inventario_dpc
  CREATE PUBLIC .
...
CLASS zclmm_inventario_dpc_ext IMPLEMENTATION.
...
* ----------------------------------------------------------------------
    ...
    lo_inventario->upload( EXPORTING iv_excel      = abap_true
                                     iv_filename   = iv_slug
