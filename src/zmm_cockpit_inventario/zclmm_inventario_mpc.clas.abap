class ZCLMM_INVENTARIO_MPC definition
  public
...
CLASS ZCLMM_INVENTARIO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMM_INVENTARIO_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCLMM_INVENTARIO_MPC=>TS_UPLOAD' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20211001195204'.                  "#EC NOTEXT
