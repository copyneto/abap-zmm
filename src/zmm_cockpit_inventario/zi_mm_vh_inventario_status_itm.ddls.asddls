...
define view entity ZI_MM_VH_INVENTARIO_STATUS_ITM as select from    dd07l as Domain
                                   ...
                                   and _Text.ddlanguage = $session.system_language
{
  ...
  key cast( Domain.domvalue_l as ze_counting_status ) as Status,
      @Semantics.text: true
      @Search.defaultSearchElement: true
      @Search.ranking: #HIGH
...
where
      Domain.domname  = 'ZD_COUNTING_STATUS'
