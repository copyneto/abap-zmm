...
* Data...........: 10/02/2022
*----------------------------------------------------------------------------*
REPORT zmmr_analise_transfer_lote.
...
*Preenche dados localizaÁ„o Inicio
  ...
  LOOP AT gt_emseg ASSIGNING <fs_emseg> .

    gs_log-msgid = <fs_emseg>-msgid .
    gs_log-msgno = <fs_emseg>-msgno .
    gs_log-msgty = <fs_emseg>-msgty .
...
*** Recupera objeto da nota fiscal
  ...
  IF gv_nfobj IS NOT INITIAL.
    ...
    LOOP AT gt_obj_item ASSIGNING <fs_items>.
