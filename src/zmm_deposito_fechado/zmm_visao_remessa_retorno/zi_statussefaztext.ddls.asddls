...
@EndUserText.label: 'Status Sefaz Tex'
...
define view entity zi_StatusSefazText
                                   ...
                                   and _Text.ddlanguage = $session.system_language
{
  ...
  key cast( Domain.domvalue_l as ze_mm_status_sefaz ) as StatusNF,
      @Semantics.text: true
...
where
      Domain.domname    = 'ZD_MM_STATUS_SEFAZ'
