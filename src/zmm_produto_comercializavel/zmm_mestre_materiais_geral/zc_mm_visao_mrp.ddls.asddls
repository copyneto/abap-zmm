@EndUserText.label: 'Visão de MRP'
@AccessControl.authorizationCheck: #NOT_REQUIRED
@Metadata.allowExtensions: true
define root view entity ZC_MM_VISAO_MRP
  as projection on ZI_MM_VISAO_MRP
{
  ...
  key werks,
      @Consumption.valueHelpDefinition: [{ entity: { name: 'C_ProductMRPAreaVH', element: 'MRPArea' } }]
  key berid,
