class ZCLMM_CX_FMT_PAGAMENTO_ERRO definition
  public
...
public section.
  ...
  data STANDARD type ZCLMM_EXCHANGE_FAULT_DATA5 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLMM_EXCHANGE_FAULT_DATA5 optional
...
CLASS ZCLMM_CX_FMT_PAGAMENTO_ERRO IMPLEMENTATION.
