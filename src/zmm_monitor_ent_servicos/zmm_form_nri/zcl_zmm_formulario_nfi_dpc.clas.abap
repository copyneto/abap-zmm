class ZCL_ZMM_FORMULARIO_NFI_DPC definition
  public
...
protected section.
  ...
  methods PDFFILESET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZMM_FORMULARIO_NFI_MPC=>TS_PDFFILE
    raising
  ...
  methods PDFFILESET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZMM_FORMULARIO_NFI_MPC=>TT_PDFFILE
...
CLASS ZCL_ZMM_FORMULARIO_NFI_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 31.03.2022 17:27:31 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZMM_FORMULARIO_NFI_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA pdffileset_create_entity TYPE zcl_zmm_formulario_nfi_mpc=>ts_pdffile.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA pdffileset_get_entity TYPE zcl_zmm_formulario_nfi_mpc=>ts_pdffile.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZMM_FORMULARIO_NFI_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA pdffileset_get_entityset TYPE zcl_zmm_formulario_nfi_mpc=>tt_pdffile.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA pdffileset_update_entity TYPE zcl_zmm_formulario_nfi_mpc=>ts_pdffile.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
