class ZCLMM_FORMULARIO__01_DPC_EXT definition
  public
  inheriting from ZCLMM_FORMULARIO__01_DPC
  create public .
...
CLASS ZCLMM_FORMULARIO__01_DPC_EXT IMPLEMENTATION.
...
*      ENDIF.
      ...
      IF lv_po IS NOT INITIAL.
        ...
        ls_lheader-value = COND #( WHEN lt_campos_chave[ 1 ]-purchaseorderitem = '1' THEN 'inline; filename="'
