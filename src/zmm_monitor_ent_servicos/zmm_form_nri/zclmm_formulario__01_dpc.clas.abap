class ZCLMM_FORMULARIO__01_DPC definition
  public
...
protected section.
  ...
  methods PDFFILESET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCLMM_FORMULARIO__01_MPC=>TS_PDFFILE
    raising
  ...
  methods PDFFILESET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCLMM_FORMULARIO__01_MPC=>TT_PDFFILE
...
CLASS ZCLMM_FORMULARIO__01_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 01.04.2022 09:58:12 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCLMM_FORMULARIO__01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA pdffileset_create_entity TYPE zclmm_formulario__01_mpc=>ts_pdffile.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA pdffileset_get_entity TYPE zclmm_formulario__01_mpc=>ts_pdffile.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCLMM_FORMULARIO__01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA pdffileset_get_entityset TYPE zclmm_formulario__01_mpc=>tt_pdffile.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA pdffileset_update_entity TYPE zclmm_formulario__01_mpc=>ts_pdffile.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
