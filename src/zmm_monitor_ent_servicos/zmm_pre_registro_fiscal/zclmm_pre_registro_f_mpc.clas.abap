class ZCLMM_PRE_REGISTRO_F_MPC definition
  public
...
TT_FILEUPLOAD type standard table of TS_FILEUPLOAD .
  ...
  constants GC_PDFURL type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PdfURL' ##NO_TEXT.
...
CLASS ZCLMM_PRE_REGISTRO_F_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMM_PRE_REGISTRO_FISCAL_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'UploadAssoc' "#EC NOTEXT
                            iv_left_type        = 'PdfURL' "#EC NOTEXT
                            iv_right_type       = 'FileUpload' "#EC NOTEXT
...
* Navigation Properties for entity - PdfURL
lo_entity_type = model->get_entity_type( iv_entity_name = 'PdfURL' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'FileUploadSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'FILEUPLOADSET' "#EC NOTEXT
                                                              iv_association_name = 'UploadAssoc' ). "#EC NOTEXT
  endmethod.
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CnpjCpf' iv_abap_fieldname = 'CNPJ_CPF' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Conteudo' iv_abap_fieldname = 'CONTEUDO' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCLMM_PRE_REGISTRO_F_MPC=>TS_FILEUPLOAD' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CnpjCpf' iv_abap_fieldname = 'CNPJCPF' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 16 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Linha' iv_abap_fieldname = 'LINHA' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCLMM_PRE_REGISTRO_F_MPC=>TS_PDFFILE' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PdfURL' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCLMM_PRE_REGISTRO_F_MPC=>TS_PDFURL' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PdfURLSet' ). "#EC NOTEXT
