...
define view entity ZI_MM_EXPED_SUBCONTRAT_ITEM
...
//  association to parent zi_mm_rkpf_reserva    as _HeaderReserva  on  _HeaderReserva.Rsnum = $projection.Rsnum
  
//  association to parent ZI_MM_EXPED_SUBCONTRAT     as _Header  on  _Header.Rsnum = $projection.Rsnum
//                                                               and _Header.Rspos = $projection.Rspos
