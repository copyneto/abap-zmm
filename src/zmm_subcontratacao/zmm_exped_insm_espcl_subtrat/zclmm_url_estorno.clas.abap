class ZCLMM_URL_ESTORNO definition
  public
  final
  create public .
...
CLASS ZCLMM_URL_ESTORNO IMPLEMENTATION.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    CONSTANTS: lc_param_doc     TYPE ihttpnam VALUE 'DOCNUM-LOW',
               ...
               lc_param2_vbln2  TYPE ihttpnam VALUE 'LF_ANAUS',
    ...
    DATA lt_calculated_data TYPE STANDARD TABLE OF zc_mm_expedinsum_espc_subcontr WITH DEFAULT KEY.
    ...
    IF lt_calculated_data[] IS NOT INITIAL.
      ...
      SELECT docnum,
       ...
       WHERE docnum = @lt_calculated_data-docnum
...
*                                        WITH KEY docnum = <fs_calculated>-docnum
*                                        BINARY SEARCH.
*        IF sy-subrc IS INITIAL.
        ...
        READ TABLE lt_t001w ASSIGNING FIELD-SYMBOL(<fs_t001w>)
                                          ...
                                          BINARY SEARCH.
        IF sy-subrc IS INITIAL
       AND <fs_calculated>-docnum IS NOT INITIAL.
        ...
        ELSEIF <fs_calculated>-vbeln IS NOT INITIAL.
          ...
          APPEND VALUE #( name  = lc_param2_vbln2
                          value = abap_true ) TO lt_parameters.
