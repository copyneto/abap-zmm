class ZCLMM_URL_ESTORNO_ARMAZ definition
  public
  final
  create public .
...
CLASS ZCLMM_URL_ESTORNO_ARMAZ IMPLEMENTATION.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    DATA lt_calculated_data TYPE STANDARD TABLE OF zc_mm_exped_armazenagem WITH DEFAULT KEY.
    ...
    LOOP AT lt_calculated_data ASSIGNING FIELD-SYMBOL(<fs_calculated>).
      ...
      OR <fs_calculated>-status EQ TEXT-002.
        ...
        IF sy-subrc IS INITIAL.
          APPEND VALUE #( name = lc_param_doc
                          value = <fs_calculated>-docdocnum ) TO lt_parameters.
      ...
      IF <fs_calculated>-docdocnum IS NOT INITIAL.
        FREE: lt_parameters[].
