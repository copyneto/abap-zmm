...
@EndUserText.label: 'CDS ADM Retorno da Industrialização'
define root view entity ZI_MM_ADM_RETORNINDUST
  as select from    /xnfe/innfehd        as _ehd

    inner join ZI_MM_FILTRO_INNFEIT_INDUST as _eit on  _ehd.guid_header = _eit.GuidHeader
//                                                 and _eit.Cfop        = '6125'
//                                                 or  _eit.Cfop        = '5125'
//                                                 or  _eit.Cfop        = '5124'
//                                                 or  _eit.Cfop        = '6124'
  ...
  association [0..1] to ZI_MM_FILTRO_STATUS as _STATUS  on _STATUS.Status   = $projection.Status
{
  ...
  key _ehd.nnf                as Nnf,
  @Consumption.valueHelpDefinition:   [{ entity: {name: 'ZI_MM_VH_ADM_RETIND_XML', element: 'nfeid' } }]
