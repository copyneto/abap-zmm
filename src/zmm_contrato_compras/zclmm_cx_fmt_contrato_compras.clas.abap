class ZCLMM_CX_FMT_CONTRATO_COMPRAS definition
  public
...
public section.
  ...
  data STANDARD type ZCLMM_EXCHANGE_FAULT_DATA2 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLMM_EXCHANGE_FAULT_DATA2 optional
...
CLASS ZCLMM_CX_FMT_CONTRATO_COMPRAS IMPLEMENTATION.
