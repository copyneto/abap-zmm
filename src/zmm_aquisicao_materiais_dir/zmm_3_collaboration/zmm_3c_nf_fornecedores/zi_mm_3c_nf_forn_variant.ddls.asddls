...
define view entity ZI_MM_3C_NF_FORN_VARIANT
  as select from ztmm_3c_variant

  association        to parent ZI_MM_3C_NF_FORNECEDORES as _JOB       on _JOB.JobUUId = $projection.JobUUId
  ...
  association [0..1] to I_CmmdtyDrvtvOrderUserDetails   as _ChangedBy on _ChangedBy.UserID = $projection.ChangedBy
{
  key scruuid                                       as ScrUUId,
      ...
      cast( 'ZMMR_3C_NF_FORNECEDORES' as progname ) as ProgramName,
