...
@EndUserText.label: '3Collaboration JOB - NF Fornecedores'
...
define root view entity ZI_MM_3C_NF_FORNECEDORES
  as select from ztmm_3c_job as _Job
  //    left outer join ztmm_3c_job_log         as _Link   on _Link.jobuuid = _Job.jobuuid
  //    left outer join      APL_V_APPL_LOG_OVERVIEW as _Handle on _Handle.log_handle = _Link.loghandle

  composition [0..*] of ZI_MM_3C_NF_FORN_VARIANT      as _Variant
