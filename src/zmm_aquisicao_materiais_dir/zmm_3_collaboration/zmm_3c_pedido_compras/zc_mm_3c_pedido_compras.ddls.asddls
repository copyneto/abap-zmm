@EndUserText.label: '3Collaboration Ped. Comp. - JOB'
@AccessControl.authorizationCheck: #CHECK
@ObjectModel.semanticKey: ['LogExternalId']
@Metadata.allowExtensions: true
define root view entity ZC_MM_3C_PEDIDO_COMPRAS
  as projection on ZI_MM_3C_PEDIDO_COMPRAS
{
  ...
  key JobUUId,
      ...
      @Consumption.valueHelpDefinition: [{ entity: { name: 'ZI_MM_VH_3C_JOB_VARIANTE_PO', element: 'LogExternalId' } }]
      LogExternalId,
      ...
      //      /* Associations */
      _Variant : redirected to composition child ZC_MM_3C_PED_COMP_VARIANT,
