class ZCLMM_CX_FML_FOLHA_REGISTRO_SE definition
  public
...
public section.
  ...
  data STANDARD type ZCLMM_EXCHANGE_FAULT_DATA3 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLMM_EXCHANGE_FAULT_DATA3 optional
...
CLASS ZCLMM_CX_FML_FOLHA_REGISTRO_SE IMPLEMENTATION.
