class ZCLMM_CX_FMT_PEDIDO_COMPRA definition
  public
...
public section.
  ...
  data STANDARD type ZCLMM_EXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLMM_EXCHANGE_FAULT_DATA optional
...
CLASS ZCLMM_CX_FMT_PEDIDO_COMPRA IMPLEMENTATION.
